package com.example.retrofitapplication.allProducts.view;
...
public class AllProductsAdapter extends RecyclerView.Adapter<AllProductsAdapter.ViewHolder> {
    ...
    public AllProductsAdapter (Context context , List<Product> products,onFavouriteClickListener listner){
    ...
    @NonNull
    @Override
    public AllProductsAdapter .ViewHolder onCreateViewHolder(@NonNull ViewGroup recyclerView, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(recyclerView.getContext());
        View v = inflater.inflate(R.layout.item_product, recyclerView , false);
        AllProductsAdapter.ViewHolder vh = new AllProductsAdapter .ViewHolder(v);
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder{
        ...
        public  ViewHolder(View v){
            ...
            removeBtn=v.findViewById(R.id.favBtn);
